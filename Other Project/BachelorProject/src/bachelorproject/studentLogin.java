...
public class studentLogin extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        studentRegistrationForm studentRegistrationObj = new studentRegistrationForm();
        setVisible(false);
        studentRegistrationObj.setVisible(true);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            String sql = "Select UserName, Password from studentRegistration where UserName='"+userName.getText()+"'";
